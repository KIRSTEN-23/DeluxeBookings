const Listing = require("../../features/listings/listingSchema");
...
const searchListings = async (req, res) => {
  try {
    ...
    // Search bar
    if (guestCapacity && guestCapacity !== "") {
      queryFilter.guestCapacity = Number(guestCapacity);
    }
    ...
    if (province && province !== "") {
      queryFilter["location.province"] = province;
    }
    ...
    if (amenities) {
      ...
      queryFilter.amenities = { $all: amenityArray };
    }
