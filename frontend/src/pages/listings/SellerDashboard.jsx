...
// import SellerManageMyListingsSection from "../../components/listings/SellerManageMyListingsSection.jsx";
// // import SellerManageMyBookingsSection from "../../components/seller/SellerManageMyBookingsSection.jsx";
...
//     <main className="seller-dashboard-page">
//       <Container fluid="lg" className="py-4 py-lg-5">
//         <header className="seller-dashboard-header mb-4">
//           <p className="seller-kicker">Host workspace</p>

//           <div className="d-flex justify-content-between align-items-end gap-3 flex-wrap">
//             <div>
//               <h1 className="seller-dashboard-title">
//                 <span>Seller</span> <em>Dashboard</em>
//               </h1>

//               <p className="seller-dashboard-meta mb-0">
//                 Manage your listings, bookings, and property activity from one place.
//               </p>
//             </div>

//             <Link
//               to="/seller/listings/new"
//               className="btn btn-primary seller-primary-action"
//             >
//               Create Listing
//             </Link>
//           </div>
...
//           <Button
//             type="button"
//             variant={activeSection === "listings" ? "dark" : "outline-dark"}
...
//           <Button
//             type="button"
//             variant={activeSection === "bookings" ? "dark" : "outline-dark"}
